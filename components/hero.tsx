      ...
      <div className=" p-4 max-w-7xl  mx-auto relative z-10 w-full pt-20 md:pt-0">
        ...
        <center className="relative">
          <div className="flex gap-3 items-center justify-center">
            <Link href={"#projects"} className="relative inline-flex h-12 overflow-hidden rounded-full p-[2px] mt-4 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
            ...
            <a href="./1HK21CS129_Roopsagar_K.pdf" download="Roopsagar_K_Resume.pdf">
              <Button className="rounded-full mt-4 py-2">Download CV</Button>
            </a>
          </div>
