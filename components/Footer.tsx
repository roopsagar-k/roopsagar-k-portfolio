...
const Footer = () => {
    ...
    return (
        <footer className="relative w-full md:pt-20 pb-10 px-4 md:px-28" id="contact">
            {/* Background grid */}
            ...
            <div className="w-full max-w-[40rem] h-5 md:h-10 relative">
                ...
                <p className="text-white-200 mt-10 my-5 text-center">
                    I&apos;m excited to hear from you! Whether you have a project in mind, want to discuss potential opportunities,
