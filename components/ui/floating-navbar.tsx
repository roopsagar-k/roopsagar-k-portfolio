  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <button onClick={() => router.push("#contact")} className="border text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-black dark:text-white px-4 py-2 rounded-full">
          <span>Contact</span>
